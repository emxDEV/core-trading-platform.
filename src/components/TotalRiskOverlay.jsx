...
const TotalRiskOverlay = () => {
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 mb-6">
            <div className="lg:col-span-3 bg-slate-900/40 backdrop-blur-[45px] rounded-[2.5rem] p-6 border border-white/10 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] relative overflow-hidden group transition-all duration-700 hover:border-primary/40">
            ...
            <div className="bg-slate-900/40 backdrop-blur-[45px] border border-white/10 rounded-[2.5rem] p-6 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] flex flex-col justify-center items-center text-center relative overflow-hidden group/utilization transition-all duration-700 hover:border-primary/40">
                {/* Glass Reflection Highlight */}
                <div className="absolute inset-0 bg-gradient-to-br from-white/[0.05] to-transparent pointer-events-none" />
                ...
                <div className="absolute top-6 right-6 transition-transform duration-700 group-hover/utilization:rotate-12 opacity-20">
                    <span className="material-symbols-outlined text-white text-4xl select-none">share_reviews</span>
                </div>

                <span className="text-[10px] font-black text-slate-500 uppercase tracking-[0.3em] mb-4 relative z-10 transition-colors group-hover/utilization:text-primary/70">Fleet Utilization</span>

                <div className="relative z-10 flex flex-col items-center gap-1 mb-4">
                    <div className="text-5xl font-black text-white tracking-tighter drop-shadow-glow group-hover/utilization:scale-110 transition-transform duration-500 italic">
                        {fleetStats.count}
                    </div>
                    <span className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] mt-1">Deployed Units</span>
                </div>
